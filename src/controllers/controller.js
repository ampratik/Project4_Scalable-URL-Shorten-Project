...
//Connection to Redis
const redisClient = redis.createClient({ host: 'redis-19122.c212.ap-south-1-1.ec2.cloud.redislabs.com', port:19122, username: 'Pratik-free-db', password: 'WHr6bdJE4XBlqCiWgyCoTSU8Q59Vj8V5' });
...
const getUrl = async (req, res) => {
    try {
        ...
        if (cachedUrlCode) {
            ...
            return res.status(200).redirect(JSON.parse(cachedUrlCode))
